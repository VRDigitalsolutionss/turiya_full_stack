...
const { handleAddCourseCategorylatest, getAllCourseCategoriesLatest } = require('../controller/course_and_modules/courseCategoryLatest');
...
courseCategoryLatestRoute.put('/edit_course_category/:id', editCourseCategory);
