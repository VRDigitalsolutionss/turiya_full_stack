...
const { get_purchasedModule, get_totalpurchasedModule, get_purchasedModule2, deleteOldPurchasedModules } = require('../controller/course_and_modules/purchasedModule');
