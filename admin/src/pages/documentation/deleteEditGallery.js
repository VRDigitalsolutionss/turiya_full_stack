...
const EditGallery = () => {
  ...
  const handleFileChange = (e) => {
    setFileUrl(e.target.files[0]); // For previewing new file
  };
  ...
  //     if (id) {
  //       axios
  //       .put(`http://127.0.0.1:7000/api/edit_gallery/${id}`, payload)
  //       .then((response) => {
  ...
  //       axios
  //       .post('http://127.0.0.1:7000/api/add_gallery', payload)
  //         .then((response) => {

  //           console.log("add_gallery", response)
  //         if (response.status === 201) {
  //           alert('Gallery Added successfully');
  //           setFileUrl('');
  //           setName('');
  ...
  //   // Create FormData to include the file and other fields
  //   const formData = new FormData();
  //   formData.append('name', name); // Add the name field
  //   formData.append('file', fileUrl); // Add the file field

  //   const apiEndpoint = id
  //     ? `http://127.0.0.1:7000/api/edit_gallery/${id}`
  //     : 'http://127.0.0.1:7000/api/add_gallery';

  //   const requestType = id ? axios.put : axios.post;

  //   // Send the FormData to the server
  //   requestType(apiEndpoint, formData, {
  //     headers: {
