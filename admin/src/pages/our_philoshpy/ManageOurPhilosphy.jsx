...
const ManageOurPhilosphy = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(BASE_URL + `/our_philosophy/${id}`)
      .then((response) => {
    ...
    // response data -->   Slide_Image
    // :
    // "19219.jpg"
    // Slider_Heading
    // :
    // "Welcome to Our Journey updated"
    // Slider_Paragraph
    // :
    // "Discover the incredible story behind our vision and journey."
    // Slider_videolink
    // :
    ...
    if (id) {
      try {
        ...
        const response = await axios.put(
          BASE_URL + `/edit_our_philosophy/${id}`,
          formData
        );
...
export default ManageOurPhilosphy;
