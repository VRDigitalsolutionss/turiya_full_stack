...
const ManageTuriyaYogaTeam = () => {
  ...
  useEffect(() => {
    axios
      .get(BASE_URL + `/customer_testimonial/${id}`)
      .then((response) => {
    ...
    if (id) {
      try {
        ...
        const response = await axios.put(
          BASE_URL + `/edit_customer_testimonial/${id}`,
          formData
        );
      ...
      try {
        ...
        const response = await axios.post(
          BASE_URL + "/add_customer_testimonial/",
          formData
        );
...
export default ManageTuriyaYogaTeam;
