...
//             <img src="https://www.turiyayoga.de/admin/assets/images/logo.webp" alt style={{width: '11rem'}} />
//           </div>
//           <h4 className=" py-4 text-center">Enter Details for Login</h4>
//           {/* form */}
//           <form method="POST">
//             <div className="mb-3">
//               <label htmlFor="emailaddress" className="form-label">Enter Username</label>
//               <input className="form-control" name="username" type="text" id="emailaddress" required placeholder="Enter your username" />
//             </div>
//             <div className="mb-3">
...
//                 </div>
//               </div>
//               <a href="forget.php" className="text-muted float-end py-2"><small>Forgot
//                   your
//                   password?</small></a>
//             </div>
//             <div className="mb-2  text-start">
//               <button className="btn btn-soft-primary-custom w-100 mt-3" type="submit" name="admin-login"><i className="ri-login-circle-fill me-1" /> <span className="fw-bold">Log
//                   In</span> </button>
//             </div>
