            ...
            <div className="third_section__grid">
              <div
                ...
                <div className="box_img">
                  <img
                    src="https://api.turiyayoga.de/uploads/assets/new/yoga1.webp"
                    className="img-fluid"
                    alt="yoga"
                  />
                </div>
              ...
              <div
                ...
                <div className="box_img">
                  <img
                    src="https://api.turiyayoga.de/uploads/assets/new/yoga2.webp"
                    className="img-fluid"
                    alt="yoga"
                  />
                </div>
              ...
              <div
                ...
                <div className="box_img">
                  <img
                    src="https://api.turiyayoga.de/uploads/assets/new/yoga3.webp"
                    className="img-fluid"
                    alt="yoga"
                  />
                </div>
              ...
              <div
                ...
                <div className="box_img">
                  <img
                    src="https://api.turiyayoga.de/uploads/assets/new/yoga4.webp"
                    className="img-fluid"
                    alt="yoga"
                  />
                </div>
              ...
              <div
                ...
                <div className="box_img">
                  <img
                    src="https://api.turiyayoga.de/uploads/assets/new/yoga5.webp"
                    className="img-fluid"
                    alt="yoga"
                  />
                </div>
