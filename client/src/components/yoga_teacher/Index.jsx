...
const faqItems6 = [
  {
    question: "Was werde ich Ã¼ber Yoga-Geschichte und Philosophie lernen?",
    answer: [
      "• Die Geschichte des Yoga: Dies beinhaltet den kulturellen Hintergrund des Yoga sowie einen Überblick darüber, wie es sich im Laufe der Zeit in Schlüsselmomenten der Geschichte entwickelt hat. Die Klassen präsentieren indische traditionelle Perspektive zusammen mit wissenschaftlicher Sicht.",
      "• Einführung in die Veden, Mahabharata (das indische Epos) und die Upanisaden in ihrer Beziehung zum Yoga;",
      "• Einblick in die Samkhya-Philosophie, die den Hintergrund für die Schriften bildet, die für Yoga noch heute von entscheidender Bedeutung sind, wie die Yoga-Sutras.",
      ...
      "• Einblick in das Tantra, die einen wichtigen Hintergrund für die Hatha Yoga Schriften bildet.",
      "• und natürlich, Hatha Yoga als Yoga Pfad (Hathapradipka).",
      "Es ist wichtig zu betonen, dass wir dir eine solide Wissensgrundlage und zusätzliche Themen bieten, von denen aus du dein eigenes Wachstum fortsetzen und in Zukunft dich weiter bilden kannst. Wenn du daran interessiert bist, dieses Wissen zu vertiefen, heißen wir dich in unseren anderen Yogalehrer-Ausbildungsmodulen (Modul 3, Modul 4 und Modul 5) willkommen.",
      "Wenn du sogar mehr Details über unser Programm wissen möchtest, solltest du auch die Yogausbildungsinhalte auf Modul 1 und Modul 2 lesen. Wenn es nicht reicht, kontaktiere uns einfach."
    ],
  },
];
...
const faqItems7 = [
  {
    question: "Was ist mit der Entwicklung meiner QualitÃ¤ten als Yogalehrer ? Habe ich Erfahrung im Unterrichten?",
    answer: [
...
const faqItems8 = [
  {
    question: "Warum sollte ich das alles studieren?",
    answer: [
      "• Das Unterrichten von Yoga kann nur aus deiner eigenen Praxis stammen. Neuausbildung ist ein großer Teil des Yogalehrer-Ausbildungsprogramms. Zum Unterrichten benötigst du jedoch Techniken, mit denen du andere sicher in ihrer eigenen Praxis führen kannst. Menschen haben sehr unterschiedliche Körper, körperliche Fähigkeiten, Lerntypen, Anliegen und Kulturen.",
...
const Index = () => {
  ...
  const fetchData = () => {
    axios
      .get(BASE_URL + "/course_web_page_by_course_category/200H AYA Yogalehrer Ausbildung - Intensiv")
      .then((response) => {
        console.log("response of yogalehrer_Ausbildung", response.data);
