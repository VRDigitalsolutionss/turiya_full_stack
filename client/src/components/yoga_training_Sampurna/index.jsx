...
console.log("closestUpcomingCourses",closestUpcomingCourse)
  ...
  const fetchData = () => {
    axios.get( BASE_URL + '/module_webpages_by_category/200H AYA Yogalehrer Ausbildung Sampurna Seminarhaus').then((response) => {
      console.log("response of yoga training sampurna", response.data.data[0]);
...
<SimpleBanner3 banner={bannerImg && bannerImg} heading={mainData.yogaTeamSliderHeading} para={mainData.yogaTeamSliderParagraph} videoLink={mainData.yogaTeamSliderVideoLink}
        buttonTxt='VIDEO' />
          ...
          <div className="container">
            <div className="sampurna_wrapper__content" data-aos="fade-up">
              ...
              <p>
                ...
                umgeben von Quellen, viel frischer Luft und den Wiesen und
                Wäldern des Taunus. Von Wiesbaden und Mainz sind wir in weniger
                als <strong>30 Minuten </strong> zu erreichen.
              </p>
              <div className="yoga-list-img">
              ...
              <p>
                ...
                tägliche Routine wird früh mit einer Yoga-Praxis umgeben von
                Natur und Stille beginnen. Die Yogahallen sind schön,
                komfortabel und haben alles, was Sie brauchen, um Deine
                Yoga-Praxis zu vertiefen und Lehrfähigkeiten zu entwickeln.
              </p> 
              <div className="yoga-list-img">
              ...
              <p>
                Nachdem Körper und Geist durch eine nährende Yogapraxis am
                Morgen zur Ruhe gekommen sind, können die Teilnehmer ein
                leckeres Frühstück genießen. Später tauchen wir in Klassen wie
                ...
                sowohl auf als auch neben der Matte pflegen. Am Ende des Tages,
                um unsere Energie wiederherzustellen, bieten wir eine weitere
              ...
              <div className="text-center">
                ...
                <p>
                  - 11h00: Philosophie/ Geschichte11h - 12h30
                  Unterrichtsmethodik
                </p>
                ...
                <p>- 18h00 Unterrichtsmethodik18h</p>
                <p>
                  Frage- und Antwortzeiten finden in der Regel zweimal während
                  des Kurses statt.
                </p>
              </div>
              <p>
                *Änderungen im Zeitplan können gelegentlich vorkommen, so wie im
                Leben generell. Diese Änderungen werden jedoch stets mit dem
                Ziel vorgenommen, die Qualität der Yogalehrerausbildung
              ...
              <div className="text-center">
                ...
                <p>
                  Für Tagesgäste beträgt die Gebühr 48 € pro Tag
                  (Mindestbuchung) und umfasst die Nutzung von Dusche, Sauna und
                  Toilette sowie verschiedene Teesorten, Früchte, Kekse, Kaffee
                  aus der Kanne und das Mittagsbuffet.
                </p>
              ...
              <p>
                ** Bitte beachte, dass Turiya Yoga die
                200-Stunden-Yogalehrerausbildung im Sampurna Seminarhaus
                anbietet. Die Teilnehmerinnen und Teilnehmer werden gebeten,
                ihre Unterkunft und Verpflegungspakete eigenständig zu buchen.
                Denke daran, dass Turiya Yoga-Teilnehmende von speziellen
                Paketpreisen profitieren. Stelle sicher, dass du deutlich
                angibst, dass du an einer Turiya Yogalehrer-Ausbildung
                teilnimmst, um die Ermäßigung zu erhalten und die Gebühren wie
                oben aufgeführt angeboten zu bekommen.
              </p>
              <h4>Mahlzeiten</h4>
              <p>
              ...
              <p>
                ...
                den umfangreichen Lerninhalten und der natürlichen Reinigung,
                die während einer intensiven Lehrerausbildung wie dieser
                stattfinden, zu erholen. Sie bieten auch die Möglichkeit, eine
                tiefere Erfahrung mit den verschiedenen Kategorien von
                Körperhaltungen, unterschiedlichen Ausrichtungen und ihren
                möglichen psychologischen oder emotionalen Auswirkungen zu
                machen.
              </p>
              <div className="yoga-list-img">
                <img
              ...
              <p>
                ...
                und/oder Instituten innerhalb und außerhalb Indiens studiert.
                Alle Klassen werden mit Wissen, Erfahrung und Freude von Herzen
                unterrichtet. Turiya Yoga öffnet auch seine Türen, um
                inspirierende Yogis in unserer Gemeinschaft willkommen zu
                heißen, indem wir wann immer möglich Meisterklassen anbieten.
              </p>
              <p>
                  ...
                  <div className="about_turiya__right">
                    <ul>
                      <li>
                        ...
                        kommen. Die Ausbildung ist ein wichtiger Teil deines
                        Wegs als Yogalehrer. Um unterrichten zu können, brauchst
                        du Techniken, um andere sicher in ihrer eigenen Praxis
                        anzuleiten. Menschen haben sehr unterschiedliche Körper,
                        körperliche Fähigkeiten, Lerntypen, Anliegen und
                        Kulturen.
                      </li>
                      <li>
                        ...
                        Biomechanik wissen musst. Darüber hinaus wirst du im
                        Laufe des Kurses mit verschiedenen Anpassungen,
                        Requisiten und unterstützenden Techniken
                        experimentieren.
                      </li>
                      <li>
                        ...
                        individuellen, natürlichen Yogalehrerqualitäten zu
                        finden und zu schätzen, sondern du wirst auch lernen,
                        wesentliche Yogalehrerqualitäten zu entwickeln, die dir
                        helfen, deine Teilnehmerinnen klar zu lesen und ihre
                        unterschiedlichen Lernstile durch deinen Unterricht zu
                        unterstützen.
                      </li>
                      <li>
                        Damit deine zukünftigen Teilnehmer*innen die Tiefe des
                        Yoga spüren und zu einer disziplinierten Praxis
                        inspiriert werden, wirst du etwas über die Philosophie
                        und Geschichte des Yoga lernen. Die Schriften sind der
                        Treibstoff, der uns zum Üben antreibt, und die Praxis
                        gibt uns die Erfahrung, um wirklich zu verstehen, was
                        die Schriften bedeuten: In einem Kreislauf befruchten
                        sich Philosophie und Praxis gegenseitig.
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <p>
                ...
                Online-Videokurse angeboten, und auch Hausaufgaben werden
                entweder während des Kurses und/oder danach (abhängig vom
                Fortschritt der Teilnehmerinnen) gestellt. Zusätzlich nehmen die
                Teilnehmerinnen an mehreren praktischen Übungen (Praktika) teil.
                Wir nennen sie Übungen, weil es wichtig ist zu verstehen, dass
                die Teilnahme an der gesamten Ausbildung bewertet wird und nicht
                nur bei einer bestimmten Gelegenheit. Es gibt wichtige
                praktische Sitzungen, in denen die Teilnehmer*innen unterrichten
                und Feedback erhalten. Diese dienen jedoch nicht als endgültige
                Bewertung, sondern zur Bewertung des Fortschritts. Die
                erhaltenen Feedbacks bieten die Möglichkeit zu wachsen. Am Ende
                der Ausbildung wirst du einen deutlichen Fortschritt in deiner
                Entwicklung feststellen. Dies ist dank unserer besonderen
                Unterrichtsmethodik und der in den Kurs gesteckten Erfahrung
                möglich. Du wirst befähigt sein, Yoga sicher zu unterrichten.
              </p>
            </div>
          </div>
