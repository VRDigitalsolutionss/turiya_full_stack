              ...
              <div className="col-lg-12">
                <div className="about_wrapper__left" data-aos="fade-up">
                  ...
                  <div className="kurse_link">
                    ...
                    <a to="yogalehrer-ausbildung-module-200h">MODUL 2</a>
                    <a to="yogalehrer-ausbildung-300h">MODUL 3</a>
                    <a to="yogalehrer-ausbildung-400h">MODUL 4</a>
                    <a to="yogalehrer-ausbildung-500h">MODUL 5</a>
                  </div>
                  <h6>
