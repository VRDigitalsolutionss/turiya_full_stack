...
const BannerSlowerWrapper = () => {
  ...
  const fetchNextUpcomingCourse =  () => {
    axios.get(BASE_URL + '/getClosestUpcomingCourseswithNull').then((response) => {
  ...
  <div className="container">
    <div className="row">
      <div className="col-xl-4">
        <div className="slower_wrapper__center same-box aos-init aos-animate" data-aos="zoom-in-up" data-aos-duration="2000">
      ...
      <div className="col-xl-4">
        <div className="slower_wrapper__right same-box aos-init" data-aos="zoom-in-up" data-aos-duration="2000">
          ...
          <div className="slower_wrapper__right-content">
                  ...
                  <p
                      ...
                      // }}
                        ...
                        dangerouslySetInnerHTML={{ __html:closestUpcomingCourse &&  closestUpcomingCourse[0].Homepage_cardcontent }} >
            ...
            <div className="slower_wrapper__right-date aos-init" data-aos="fade-up">
              <ul>
                      <li><i className="bx bxs-map" /> {closestUpcomingCourse && closestUpcomingCourse[0].Location }</li>
                <li><i className="bx bxs-calendar me-1" />
              {  convertDateFormat(closestUpcomingCourse && closestUpcomingCourse[0].StartDate) }                        &nbsp;-&nbsp;
                           { convertDateFormat(closestUpcomingCourse && closestUpcomingCourse[0].EndDate)}      </li>
              </ul>
            </div>
            <div className="price">
                    <button className="table-btn triggerDialogBox" style={{ border: '0px solid' }} data-id={9} onClick={handletriggerDialogBox}>€{ closestUpcomingCourse && closestUpcomingCourse[0].price}</button>          </div>
          </div>
        </div>
      </div>
      <div className="col-xl-4">
        <div className="slower_wrapper__left same-box aos-init" data-aos="zoom-in-up" data-aos-duration="2000">
