...
const Munchen = () => {
  ...
  const getUpcomingCourse = () => {
    axios
      .get(BASE_URL + "/getModuleByLocation/Munchen")
      .then((response) => {
  ...
  const getUpcomingCourse2 = () => {
    axios
      ...
      .then((response) => {
        console.log("response of 60H Stuttgart Yoga", response.data.data);
        const data = response.data.data[11];
        setYin_Yoga(data);
